...
export class Cell {
  ...
  figure: Figure | null;
  board: Board;
  available: boolean; //когда выбранная фигура может походить н авыбранную ячейку то true
  id: number; //для react key
  ...
  //методы проверяют на пустоту вертикаль, диагональ, горизонталь
